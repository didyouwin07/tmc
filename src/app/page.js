  ...
  return (
    <>
      <div className={styles.message}>
        Open in mobile view for the current version
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.missionContainer}>
          ...
          <div className={styles.missionSecondaryText}>
            <div className={styles.missionLine1}>
              ...
              <div className={styles.creditDetailsInnerContainer}>
                ...
                <div className={styles.creditBenefits}>
                  ...
                  <div className={styles.creditBenefit}>
                    ...
                    <div className={styles.benefit}>
                      Starter Credits{" "}
                      <span className={styles.bold}>do not expire</span> – use
                      them as on stories of your choice
                    </div>
                  </div>
                </div>
